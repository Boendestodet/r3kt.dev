...
* @see app/Http/Controllers/ProjectController.php:711
...
* @see app/Http/Controllers/ProjectController.php:720
* @route '/projects/{project}'
*/
...
* @see app/Http/Controllers/ProjectController.php:745
* @route '/projects/{project}'
*/
...
* @see app/Http/Controllers/ProjectController.php:777
...
* @see app/Http/Controllers/ProjectController.php:804
...
const ProjectController = { index, create, store, show, edit, update, destroy, duplicate, checkName, showApi, verifySetup }
