...
* @see app/Http/Controllers/ProjectController.php:77
...
* @see app/Http/Controllers/ProjectController.php:1380
...
* @see app/Http/Controllers/ProjectController.php:1389
* @route '/projects/{project}'
*/
...
* @see app/Http/Controllers/ProjectController.php:1414
* @route '/projects/{project}'
*/
...
* @see app/Http/Controllers/ProjectController.php:1427
...
* @see app/Http/Controllers/ProjectController.php:1446
...
* @see app/Http/Controllers/ProjectController.php:1461
...
/**
* @see \App\Http\Controllers\ProjectController::getFiles
* @see app/Http/Controllers/ProjectController.php:1476
* @route '/api/projects/{project}/files'
*/
export const getFiles = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getFiles.url(args, options),
    method: 'get',
})
...
* @route '/api/projects/{project}/files'
*/
getFiles.url = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { project: args }
    }
    ...
    return getFiles.definition.url
            .replace('{project}', parsedArgs.project.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/api/projects/{project}/files'
*/
getFiles.get = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getFiles.url(args, options),
    method: 'get',
})
...
* @route '/api/projects/{project}/files'
*/
getFiles.head = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getFiles.url(args, options),
    method: 'head',
})
...
* @route '/api/projects/{project}/files'
*/
const getFilesForm = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: getFiles.url(args, options),
    method: 'get',
})
...
* @route '/api/projects/{project}/files'
*/
getFilesForm.get = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: getFiles.url(args, options),
    method: 'get',
})
...
* @route '/api/projects/{project}/files'
*/
getFilesForm.head = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: getFiles.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
getFiles.form = getFilesForm

const ProjectController = { index, create, store, show, edit, update, destroy, duplicate, checkName, showApi, getFiles }
