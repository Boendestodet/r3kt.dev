...
* @see app/Http/Controllers/ProjectController.php:1390
...
* @see app/Http/Controllers/ProjectController.php:1399
* @route '/projects/{project}'
*/
...
* @see app/Http/Controllers/ProjectController.php:1424
* @route '/projects/{project}'
*/
...
* @see app/Http/Controllers/ProjectController.php:1437
...
* @see app/Http/Controllers/ProjectController.php:1456
...
* @see app/Http/Controllers/ProjectController.php:1471
...
/**
* @see \App\Http\Controllers\ProjectSandboxController::sandbox
* @see app/Http/Controllers/ProjectSandboxController.php:17
...
/**
* @see \App\Http\Controllers\ProjectVerificationController::verifySetup
...
* @see app/Http/Controllers/ProjectController.php:1486
* @route '/api/projects/{project}/files'
*/
export const files = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/api/projects/{project}/files'
*/
files.url = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { project: args }
    }
...
* @route '/api/projects/{project}/files'
*/
files.get = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: files.url(args, options),
    method: 'get',
})
...
* @route '/api/projects/{project}/files'
*/
files.head = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: files.url(args, options),
    method: 'head',
})
...
* @route '/api/projects/{project}/files'
*/
const filesForm = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/api/projects/{project}/files'
*/
filesForm.get = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: files.url(args, options),
    method: 'get',
})
...
* @route '/api/projects/{project}/files'
*/
filesForm.head = (args: { project: number | { id: number } } | [project: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
const projects = {
    ...
    checkName: Object.assign(checkName, checkName),
    showApi: Object.assign(showApi, showApi),
    sandbox: Object.assign(sandbox, sandbox),
    verifySetup: Object.assign(verifySetup, verifySetup),
    togglePublic: Object.assign(togglePublic, togglePublic),
    deploy: Object.assign(deploy, deploy),
    docker: Object.assign(docker, docker),
    subdomain: Object.assign(subdomain, subdomain),
    customDomain: Object.assign(customDomain, customDomain),
    removeCustomDomain: Object.assign(removeCustomDomain, removeCustomDomain),
